...
> **章节信息：**所属篇章：[第三篇：LLM 应用开发](README.md) · 对应 Week 07 · 对应项目：[project-02-rag-knowledge-base](../../projects/project-02-rag-knowledge-base/README.md) · 前置章节：[上一章](chapter-18-tool-calling.md) · 后续章节：[下一章](chapter-20-token-latency-cost.md)
...
[返回全书目录](../../TABLE_OF_CONTENTS.md) · [返回学习地图](../../overview/LEARNING_MAP.md) · [上一章](chapter-18-tool-calling.md) · [下一章](chapter-20-token-latency-cost.md) · [对应周计划](../../weeks/week-07/WEEK_PLAN.md)
