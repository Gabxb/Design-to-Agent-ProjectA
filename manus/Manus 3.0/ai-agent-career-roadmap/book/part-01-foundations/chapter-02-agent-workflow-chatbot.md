...
> **章节信息：**所属篇章：[第一篇：理解 AI Agent 开发](README.md) · 对应 Week 01 · 对应项目：[project-01-tool-calling](../../projects/project-01-tool-calling/README.md) · 前置章节：[上一章](chapter-01-ai-agent-basics.md) · 后续章节：[下一章](chapter-03-job-skill-map.md)
...
[返回全书目录](../../TABLE_OF_CONTENTS.md) · [返回学习地图](../../overview/LEARNING_MAP.md) · [上一章](chapter-01-ai-agent-basics.md) · [下一章](chapter-03-job-skill-map.md) · [对应周计划](../../weeks/week-01/WEEK_PLAN.md)
