...
> **章节信息：**所属篇章：[第四篇：RAG 知识库](README.md) · 对应 Week 09 · 对应项目：[project-02-rag-knowledge-base](../../projects/project-02-rag-knowledge-base/README.md) · 前置章节：[上一章](chapter-23-document-parsing-cleaning.md) · 后续章节：[下一章](chapter-25-embedding-vector-db.md)
...
[返回全书目录](../../TABLE_OF_CONTENTS.md) · [返回学习地图](../../overview/LEARNING_MAP.md) · [上一章](chapter-23-document-parsing-cleaning.md) · [下一章](chapter-25-embedding-vector-db.md) · [对应周计划](../../weeks/week-09/WEEK_PLAN.md)
