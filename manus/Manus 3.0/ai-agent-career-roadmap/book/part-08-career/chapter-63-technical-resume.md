...
> **章节信息：**所属篇章：[第八篇：求职准备](README.md) · 对应 Week 22 · 对应项目：[project-04-capstone](../../projects/project-04-capstone/README.md) · 前置章节：[上一章](chapter-62-project-readme.md) · 后续章节：[下一章](chapter-64-architecture-diagrams.md)
...
[返回全书目录](../../TABLE_OF_CONTENTS.md) · [返回学习地图](../../overview/LEARNING_MAP.md) · [上一章](chapter-62-project-readme.md) · [下一章](chapter-64-architecture-diagrams.md) · [对应周计划](../../weeks/week-22/WEEK_PLAN.md)
