...
> **章节信息：**所属篇章：[第六篇：生产化](README.md) · 对应 Week 17 · 对应项目：[project-04-capstone](../../projects/project-04-capstone/README.md) · 前置章节：[上一章](chapter-44-unit-and-integration-tests.md) · 后续章节：[下一章](chapter-46-golden-dataset.md)
...
[返回全书目录](../../TABLE_OF_CONTENTS.md) · [返回学习地图](../../overview/LEARNING_MAP.md) · [上一章](chapter-44-unit-and-integration-tests.md) · [下一章](chapter-46-golden-dataset.md) · [对应周计划](../../weeks/week-17/WEEK_PLAN.md)
