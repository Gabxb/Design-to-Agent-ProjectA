...
> **章节信息：**所属篇章：[第七篇：作品集项目](README.md) · 对应 Week 08 · 对应项目：[project-02-rag-knowledge-base](../../projects/project-02-rag-knowledge-base/README.md) · 前置章节：[上一章](chapter-55-design-requirement-assistant.md) · 后续章节：[下一章](chapter-57-design-guideline-kb-agent.md)
...
[返回全书目录](../../TABLE_OF_CONTENTS.md) · [返回学习地图](../../overview/LEARNING_MAP.md) · [上一章](chapter-55-design-requirement-assistant.md) · [下一章](chapter-57-design-guideline-kb-agent.md) · [对应周计划](../../weeks/week-08/WEEK_PLAN.md)
