...
> **章节信息：**所属篇章：[第七篇：作品集项目](README.md) · 对应 Week 20 · 对应项目：[project-04-capstone](../../projects/project-04-capstone/README.md) · 前置章节：[上一章](chapter-58-intelligent-design-review-agent.md) · 后续章节：[下一章](chapter-60-graduation-project-packaging.md)
...
[返回全书目录](../../TABLE_OF_CONTENTS.md) · [返回学习地图](../../overview/LEARNING_MAP.md) · [上一章](chapter-58-intelligent-design-review-agent.md) · [下一章](chapter-60-graduation-project-packaging.md) · [对应周计划](../../weeks/week-20/WEEK_PLAN.md)
