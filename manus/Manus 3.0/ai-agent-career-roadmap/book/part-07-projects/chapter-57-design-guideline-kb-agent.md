...
> **章节信息：**所属篇章：[第七篇：作品集项目](README.md) · 对应 Week 12 · 对应项目：[project-02-rag-knowledge-base](../../projects/project-02-rag-knowledge-base/README.md) · 前置章节：[上一章](chapter-56-ux-research-copilot.md) · 后续章节：[下一章](chapter-58-intelligent-design-review-agent.md)
...
[返回全书目录](../../TABLE_OF_CONTENTS.md) · [返回学习地图](../../overview/LEARNING_MAP.md) · [上一章](chapter-56-ux-research-copilot.md) · [下一章](chapter-58-intelligent-design-review-agent.md) · [对应周计划](../../weeks/week-12/WEEK_PLAN.md)
