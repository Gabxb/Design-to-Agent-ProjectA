...
> **章节信息：**所属篇章：[第二篇：Python 与软件工程基础](README.md) · 对应 Week 03 · 对应项目：[project-01-tool-calling](../../projects/project-01-tool-calling/README.md) · 前置章节：[上一章](chapter-09-git-and-github.md) · 后续章节：[下一章](chapter-11-fastapi.md)
...
[返回全书目录](../../TABLE_OF_CONTENTS.md) · [返回学习地图](../../overview/LEARNING_MAP.md) · [上一章](chapter-09-git-and-github.md) · [下一章](chapter-11-fastapi.md) · [对应周计划](../../weeks/week-03/WEEK_PLAN.md)
