...
> **章节信息：**所属篇章：[第二篇：Python 与软件工程基础](README.md) · 对应 Week 02 · 对应项目：[project-01-tool-calling](../../projects/project-01-tool-calling/README.md) · 前置章节：[上一章](chapter-06-variables-functions-data.md) · 后续章节：[下一章](chapter-08-exceptions-and-logging.md)
...
[返回全书目录](../../TABLE_OF_CONTENTS.md) · [返回学习地图](../../overview/LEARNING_MAP.md) · [上一章](chapter-06-variables-functions-data.md) · [下一章](chapter-08-exceptions-and-logging.md) · [对应周计划](../../weeks/week-02/WEEK_PLAN.md)
