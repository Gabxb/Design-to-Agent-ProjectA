...
> **章节信息：**所属篇章：[第五篇：Agent 与工作流](README.md) · 对应 Week 13 · 对应项目：[project-03-agent-workflow](../../projects/project-03-agent-workflow/README.md) · 前置章节：[上一章](chapter-33-agent-principles.md) · 后续章节：[下一章](chapter-35-state-management.md)
...
[返回全书目录](../../TABLE_OF_CONTENTS.md) · [返回学习地图](../../overview/LEARNING_MAP.md) · [上一章](chapter-33-agent-principles.md) · [下一章](chapter-35-state-management.md) · [对应周计划](../../weeks/week-13/WEEK_PLAN.md)
