...
1. 先打开正式全书入口：[`BOOK.md`](BOOK.md)，或在浏览器打开 [`output/book/ai-agent-career-roadmap.html`](output/book/ai-agent-career-roadmap.html)。
2. 查看 [`TABLE_OF_CONTENTS.md`](TABLE_OF_CONTENTS.md) 和 [`READING_GUIDE.md`](READING_GUIDE.md)，选择阅读模式或每日执行模式。
3. 使用 [`overview/ONE_PAGE_OVERVIEW.md`](overview/ONE_PAGE_OVERVIEW.md) 快速查看当前位置，使用 [`overview/LEARNING_MAP.md`](overview/LEARNING_MAP.md) 和 [`overview/TECH_SKILL_MINDMAP.md`](overview/TECH_SKILL_MINDMAP.md) 把握整体方向。
4. 查看三套方案对比：[`plans/PLAN_COMPARISON.md`](plans/PLAN_COMPARISON.md)，默认方案为 C。
5. 默认从 [`weeks/week-01/days/day-01.md`](weeks/week-01/days/day-01.md) 开始。
6. 每日结束后更新 `progress/`；使用 `python update_book.py --help` 或 `python update_plan.py --help` 查看操作。
