# Week 16：智能设计评审 Agent 集成冲刺

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 4：Agent 工作流](../../overview/OUTLINE.md)
- 对应书籍章节：[第 42 章](../../book/part-05-agent-workflows/chapter-42-mcp.md)、[第 43 章](../../book/part-05-agent-workflows/chapter-43-single-and-multi-agent.md)、[第 58 章](../../book/part-07-projects/chapter-58-intelligent-design-review-agent.md)
...
本周处于“Agent 工作流”阶段。完成后，你应能说明并实践：终止条件、Tracing、成本统计；同时交付 可演示的设计评审工作流。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | 智能设计评审 Agent 集成冲刺：概念与最小示例 | 2–3 小时 |
| Day 2 | 智能设计评审 Agent 集成冲刺：基础编码练习 | 2–3 小时 |
| Day 3 | 智能设计评审 Agent 集成冲刺：功能开发 | 2–3 小时 |
| Day 4 | 智能设计评审 Agent 集成冲刺：工程化改造 | 2–3 小时 |
| Day 5 | 智能设计评审 Agent 集成冲刺：项目开发 | 2–3 小时 |
| Day 6 | 智能设计评审 Agent 集成冲刺：独立挑战与问题修复 | 2 小时 |
| Day 7 | 智能设计评审 Agent 集成冲刺：复习、整理和自由补充 | 2 小时 |
...
项目：**智能设计评审 Agent**。本周里程碑：**可演示的设计评审工作流**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 17 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
