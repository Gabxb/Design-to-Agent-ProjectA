# Week 06：结构化输出与 JSON Schema

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 2：LLM 应用开发](../../overview/OUTLINE.md)
- 对应书籍章节：[第 16 章](../../book/part-03-llm-applications/chapter-16-structured-output.md)、[第 17 章](../../book/part-03-llm-applications/chapter-17-function-calling.md)
...
本周处于“LLM 应用开发”阶段。完成后，你应能说明并实践：Schema、验证、失败处理；同时交付 研究访谈洞察结构化 API。
