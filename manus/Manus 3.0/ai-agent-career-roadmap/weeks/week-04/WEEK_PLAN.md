# Week 04：SQL、PostgreSQL、日志与集成

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 1：软件工程基础](../../overview/OUTLINE.md)
- 对应书籍章节：[第 12 章](../../book/part-02-software-engineering/chapter-12-sql-postgresql.md)、[第 13 章](../../book/part-02-software-engineering/chapter-13-testing-and-docker.md)、[第 55 章](../../book/part-07-projects/chapter-55-design-requirement-assistant.md)
...
本周处于“编程与本地开发基础”阶段。完成后，你应能说明并实践：SQL CRUD、环境变量、日志、测试；同时交付 设计需求结构化助手 API 阶段版。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | SQL 与关系建模 | 2–3 小时 |
| Day 2 | PostgreSQL 连接与仓储边界 | 2–3 小时 |
| Day 3 | 数据库异常与事务 | 2–3 小时 |
| Day 4 | 日志、测试与测试数据 | 2–3 小时 |
| Day 5 | 阶段项目：设计需求结构化助手 API | 2–3 小时 |
| Day 6 | 独立挑战：错误响应规范 | 2 小时 |
| Day 7 | 第一阶段验收与补做 | 2 小时 |
...
项目：**设计需求结构化助手 API**。本周里程碑：**设计需求结构化助手 API 阶段版**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 05 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
