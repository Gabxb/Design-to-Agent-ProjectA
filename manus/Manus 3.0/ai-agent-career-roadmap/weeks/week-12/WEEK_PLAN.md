...
- 所属阶段：[阶段 3：RAG 知识库](../../overview/OUTLINE.md)
- 对应书籍章节：[第 30 章](../../book/part-04-rag/chapter-30-citations-traceability.md)、[第 31 章](../../book/part-04-rag/chapter-31-rag-evaluation.md)、[第 32 章](../../book/part-04-rag/chapter-32-data-permission-isolation.md)、[第 57 章](../../book/part-07-projects/chapter-57-design-guideline-kb-agent.md)
- 知识地图：[全局学习地图](../../overview/LEARNING_MAP.md) · [24 周路线图](../../overview/ROADMAP_24_WEEKS.md)
- 项目：[设计规范知识库 Agent](../../projects/project-02-rag-knowledge-base/README.md)
...
本周处于“RAG 知识库”阶段。完成后，你应能说明并实践：Golden Dataset、权限过滤、评测；同时交付 设计规范知识库 Agent 阶段版。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | RAG 评测与数据隔离：概念与最小示例 | 2–3 小时 |
| Day 2 | RAG 评测与数据隔离：基础编码练习 | 2–3 小时 |
| Day 3 | RAG 评测与数据隔离：功能开发 | 2–3 小时 |
| Day 4 | RAG 评测与数据隔离：工程化改造 | 2–3 小时 |
| Day 5 | RAG 评测与数据隔离：项目开发 | 2–3 小时 |
| Day 6 | RAG 评测与数据隔离：独立挑战与问题修复 | 2 小时 |
| Day 7 | RAG 评测与数据隔离：复习、整理和自由补充 | 2 小时 |
...
项目：**设计规范知识库 Agent**。本周里程碑：**设计规范知识库 Agent 阶段版**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 13 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
