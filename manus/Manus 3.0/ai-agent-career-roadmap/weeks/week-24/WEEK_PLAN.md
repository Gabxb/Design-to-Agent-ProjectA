...
- 对应书籍章节：[第 69 章](../../book/part-08-career/chapter-69-system-design-interview.md)、[第 70 章](../../book/part-08-career/chapter-70-applications-retrospective-learning.md)
...
本周处于“求职冲刺扩展”阶段。完成后，你应能说明并实践：需求澄清、拆分、交付、复盘；同时交付 端到端模拟任务和求职跟踪系统。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | 模拟工作任务与投递复盘：概念与最小示例 | 2–3 小时 |
| Day 2 | 模拟工作任务与投递复盘：基础编码练习 | 2–3 小时 |
| Day 3 | 模拟工作任务与投递复盘：功能开发 | 2–3 小时 |
| Day 4 | 模拟工作任务与投递复盘：工程化改造 | 2–3 小时 |
| Day 5 | 模拟工作任务与投递复盘：项目开发 | 2–3 小时 |
| Day 6 | 模拟工作任务与投递复盘：独立挑战与问题修复 | 2 小时 |
| Day 7 | 模拟工作任务与投递复盘：复习、整理和自由补充 | 2 小时 |
...
项目：**全作品集**。本周里程碑：**端到端模拟任务和求职跟踪系统**。将实际实现状态记录到项目 `TASKS.md`。
