...
- 对应书籍章节：[第 66 章](../../book/part-08-career/chapter-66-five-minute-project-pitch.md)、[第 67 章](../../book/part-08-career/chapter-67-python-api-interview.md)、[第 68 章](../../book/part-08-career/chapter-68-rag-agent-interview.md)
...
本周处于“求职冲刺扩展”阶段。完成后，你应能说明并实践：Python、RAG、Agent、权衡；同时交付 技术问答库与系统设计白板稿。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | 面试与系统设计：概念与最小示例 | 2–3 小时 |
| Day 2 | 面试与系统设计：基础编码练习 | 2–3 小时 |
| Day 3 | 面试与系统设计：功能开发 | 2–3 小时 |
| Day 4 | 面试与系统设计：工程化改造 | 2–3 小时 |
| Day 5 | 面试与系统设计：项目开发 | 2–3 小时 |
| Day 6 | 面试与系统设计：独立挑战与问题修复 | 2 小时 |
| Day 7 | 面试与系统设计：复习、整理和自由补充 | 2 小时 |
...
项目：**全作品集**。本周里程碑：**技术问答库与系统设计白板稿**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 24 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
