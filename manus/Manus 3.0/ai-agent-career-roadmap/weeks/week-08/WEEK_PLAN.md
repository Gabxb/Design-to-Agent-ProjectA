# Week 08：UX Research Copilot 集成冲刺

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 2：LLM 应用开发](../../overview/OUTLINE.md)
- 对应书籍章节：[第 20 章](../../book/part-03-llm-applications/chapter-20-token-latency-cost.md)、[第 21 章](../../book/part-03-llm-applications/chapter-21-prompt-injection-security.md)、[第 56 章](../../book/part-07-projects/chapter-56-ux-research-copilot.md)
- 知识地图：[全局学习地图](../../overview/LEARNING_MAP.md) · [24 周路线图](../../overview/ROADMAP_24_WEEKS.md)
- 项目：[UX Research Copilot](../../projects/project-01-tool-calling/README.md)
...
本周处于“LLM 应用开发”阶段。完成后，你应能说明并实践：API 集成、成本记录、README；同时交付 可演示的研究资料整理助手。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | UX Research Copilot 集成冲刺：概念与最小示例 | 2–3 小时 |
| Day 2 | UX Research Copilot 集成冲刺：基础编码练习 | 2–3 小时 |
| Day 3 | UX Research Copilot 集成冲刺：功能开发 | 2–3 小时 |
| Day 4 | UX Research Copilot 集成冲刺：工程化改造 | 2–3 小时 |
| Day 5 | UX Research Copilot 集成冲刺：项目开发 | 2–3 小时 |
| Day 6 | UX Research Copilot 集成冲刺：独立挑战与问题修复 | 2 小时 |
| Day 7 | UX Research Copilot 集成冲刺：复习、整理和自由补充 | 2 小时 |
...
项目：**UX Research Copilot**。本周里程碑：**可演示的研究资料整理助手**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 09 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
