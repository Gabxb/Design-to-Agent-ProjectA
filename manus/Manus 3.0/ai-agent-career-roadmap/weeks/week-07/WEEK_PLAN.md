# Week 07：Tool Calling、重试与安全边界

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 2：LLM 应用开发](../../overview/OUTLINE.md)
- 对应书籍章节：[第 18 章](../../book/part-03-llm-applications/chapter-18-tool-calling.md)、[第 19 章](../../book/part-03-llm-applications/chapter-19-retries-and-fallbacks.md)
...
本周处于“LLM 应用开发”阶段。完成后，你应能说明并实践：工具契约、超时、重试、审计日志；同时交付 受控工具调用循环。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | Tool Calling、重试与安全边界：概念与最小示例 | 2–3 小时 |
| Day 2 | Tool Calling、重试与安全边界：基础编码练习 | 2–3 小时 |
| Day 3 | Tool Calling、重试与安全边界：功能开发 | 2–3 小时 |
| Day 4 | Tool Calling、重试与安全边界：工程化改造 | 2–3 小时 |
| Day 5 | Tool Calling、重试与安全边界：项目开发 | 2–3 小时 |
| Day 6 | Tool Calling、重试与安全边界：独立挑战与问题修复 | 2 小时 |
| Day 7 | Tool Calling、重试与安全边界：复习、整理和自由补充 | 2 小时 |
...
项目：**UX Research Copilot**。本周里程碑：**受控工具调用循环**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 08 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
