...
- 所属阶段：[阶段 4：Agent 工作流](../../overview/OUTLINE.md)
- 对应书籍章节：[第 37 章](../../book/part-05-agent-workflows/chapter-37-branching-and-loops.md)、[第 38 章](../../book/part-05-agent-workflows/chapter-38-termination-and-recovery.md)、[第 39 章](../../book/part-05-agent-workflows/chapter-39-short-and-long-memory.md)、[第 40 章](../../book/part-05-agent-workflows/chapter-40-human-in-the-loop.md)
- 知识地图：[全局学习地图](../../overview/LEARNING_MAP.md) · [24 周路线图](../../overview/ROADMAP_24_WEEKS.md)
- 项目：[智能设计评审 Agent](../../projects/project-03-agent-workflow/README.md)
...
本周处于“Agent 工作流”阶段。完成后，你应能说明并实践：中断、批准、工具权限、MCP；同时交付 带人工确认的工具工作流。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | 记忆、Human-in-the-loop 与 MCP：概念与最小示例 | 2–3 小时 |
| Day 2 | 记忆、Human-in-the-loop 与 MCP：基础编码练习 | 2–3 小时 |
| Day 3 | 记忆、Human-in-the-loop 与 MCP：功能开发 | 2–3 小时 |
| Day 4 | 记忆、Human-in-the-loop 与 MCP：工程化改造 | 2–3 小时 |
| Day 5 | 记忆、Human-in-the-loop 与 MCP：项目开发 | 2–3 小时 |
| Day 6 | 记忆、Human-in-the-loop 与 MCP：独立挑战与问题修复 | 2 小时 |
| Day 7 | 记忆、Human-in-the-loop 与 MCP：复习、整理和自由补充 | 2 小时 |
...
在 `projects/project-03-agent-workflow/` 中完成一个可运行的最小功能，并至少新增一个正向测试和一个异常/边界测试。代码需要类型提示、异常处理和可读日志；密钥只能从环境变量读取。

## 本周项目里程碑

项目：**智能设计评审 Agent**。本周里程碑：**带人工确认的工具工作流**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 16 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
