# Week 09：文档解析、Chunking 与 Metadata

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 3：RAG 知识库](../../overview/OUTLINE.md)
- 对应书籍章节：[第 22 章](../../book/part-04-rag/chapter-22-rag-overview.md)、[第 23 章](../../book/part-04-rag/chapter-23-document-parsing-cleaning.md)、[第 24 章](../../book/part-04-rag/chapter-24-chunking.md)
...
本周处于“RAG 知识库”阶段。完成后，你应能说明并实践：解析、切分、元数据；同时交付 可追溯的文档切分流水线。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | 文档解析、Chunking 与 Metadata：概念与最小示例 | 2–3 小时 |
| Day 2 | 文档解析、Chunking 与 Metadata：基础编码练习 | 2–3 小时 |
| Day 3 | 文档解析、Chunking 与 Metadata：功能开发 | 2–3 小时 |
| Day 4 | 文档解析、Chunking 与 Metadata：工程化改造 | 2–3 小时 |
| Day 5 | 文档解析、Chunking 与 Metadata：项目开发 | 2–3 小时 |
| Day 6 | 文档解析、Chunking 与 Metadata：独立挑战与问题修复 | 2 小时 |
| Day 7 | 文档解析、Chunking 与 Metadata：复习、整理和自由补充 | 2 小时 |
...
项目：**设计规范知识库 Agent**。本周里程碑：**可追溯的文档切分流水线**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 10 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
