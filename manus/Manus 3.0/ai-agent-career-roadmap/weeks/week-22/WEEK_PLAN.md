# Week 22：简历、GitHub 与 Demo

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 6：求职冲刺](../../overview/OUTLINE.md)
...
- 项目：[全作品集](../../projects/project-04-capstone/README.md)
...
本周处于“求职冲刺扩展”阶段。完成后，你应能说明并实践：STAR、项目量化、录屏流程；同时交付 简历素材、主页和 Demo 脚本。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | 简历、GitHub 与 Demo：概念与最小示例 | 2–3 小时 |
| Day 2 | 简历、GitHub 与 Demo：基础编码练习 | 2–3 小时 |
| Day 3 | 简历、GitHub 与 Demo：功能开发 | 2–3 小时 |
| Day 4 | 简历、GitHub 与 Demo：工程化改造 | 2–3 小时 |
| Day 5 | 简历、GitHub 与 Demo：项目开发 | 2–3 小时 |
| Day 6 | 简历、GitHub 与 Demo：独立挑战与问题修复 | 2 小时 |
| Day 7 | 简历、GitHub 与 Demo：复习、整理和自由补充 | 2 小时 |

## 时间分配

建议投入 **12–18 小时**：概念与阅读 20%，编码与测试 45%，项目集成 20%，复盘与补做 15%。
...
项目：**全作品集**。本周里程碑：**简历素材、主页和 Demo 脚本**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 23 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
