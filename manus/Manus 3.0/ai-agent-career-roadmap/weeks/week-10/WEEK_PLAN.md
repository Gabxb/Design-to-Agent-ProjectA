# Week 10：Embedding 与向量检索

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 3：RAG 知识库](../../overview/OUTLINE.md)
- 对应书籍章节：[第 25 章](../../book/part-04-rag/chapter-25-embedding-vector-db.md)、[第 26 章](../../book/part-04-rag/chapter-26-metadata-filtering.md)
...
本周处于“RAG 知识库”阶段。完成后，你应能说明并实践：嵌入、相似度、索引、过滤；同时交付 带过滤条件的基础检索服务。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | Embedding 与向量检索：概念与最小示例 | 2–3 小时 |
| Day 2 | Embedding 与向量检索：基础编码练习 | 2–3 小时 |
| Day 3 | Embedding 与向量检索：功能开发 | 2–3 小时 |
| Day 4 | Embedding 与向量检索：工程化改造 | 2–3 小时 |
| Day 5 | Embedding 与向量检索：项目开发 | 2–3 小时 |
| Day 6 | Embedding 与向量检索：独立挑战与问题修复 | 2 小时 |
| Day 7 | Embedding 与向量检索：复习、整理和自由补充 | 2 小时 |
...
项目：**设计规范知识库 Agent**。本周里程碑：**带过滤条件的基础检索服务**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 11 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
