# Week 14：LangGraph 状态图与持久化

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 4：Agent 工作流](../../overview/OUTLINE.md)
- 对应书籍章节：[第 35 章](../../book/part-05-agent-workflows/chapter-35-state-management.md)、[第 36 章](../../book/part-05-agent-workflows/chapter-36-agent-tools.md)、[第 41 章](../../book/part-05-agent-workflows/chapter-41-langgraph.md)
...
本周处于“Agent 工作流”阶段。完成后，你应能说明并实践：State、Node、Edge、Checkpoint；同时交付 可恢复的状态化工作流原型。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | LangGraph 状态图与持久化：概念与最小示例 | 2–3 小时 |
| Day 2 | LangGraph 状态图与持久化：基础编码练习 | 2–3 小时 |
| Day 3 | LangGraph 状态图与持久化：功能开发 | 2–3 小时 |
| Day 4 | LangGraph 状态图与持久化：工程化改造 | 2–3 小时 |
| Day 5 | LangGraph 状态图与持久化：项目开发 | 2–3 小时 |
| Day 6 | LangGraph 状态图与持久化：独立挑战与问题修复 | 2 小时 |
| Day 7 | LangGraph 状态图与持久化：复习、整理和自由补充 | 2 小时 |
...
项目：**智能设计评审 Agent**。本周里程碑：**可恢复的状态化工作流原型**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 15 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
