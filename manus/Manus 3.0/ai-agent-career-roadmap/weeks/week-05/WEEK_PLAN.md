# Week 05：LLM、Token 与提示词结构

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 2：LLM 应用开发](../../overview/OUTLINE.md)
- 对应书籍章节：[第 14 章](../../book/part-03-llm-applications/chapter-14-llm-basics.md)、[第 15 章](../../book/part-03-llm-applications/chapter-15-prompt-engineering.md)
...
本周处于“LLM 应用开发”阶段。完成后，你应能说明并实践：上下文、角色、约束、评估样例；同时交付 可版本化的提示词实验记录。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | LLM、Token 与提示词结构：概念与最小示例 | 2–3 小时 |
| Day 2 | LLM、Token 与提示词结构：基础编码练习 | 2–3 小时 |
| Day 3 | LLM、Token 与提示词结构：功能开发 | 2–3 小时 |
| Day 4 | LLM、Token 与提示词结构：工程化改造 | 2–3 小时 |
| Day 5 | LLM、Token 与提示词结构：项目开发 | 2–3 小时 |
| Day 6 | LLM、Token 与提示词结构：独立挑战与问题修复 | 2 小时 |
| Day 7 | LLM、Token 与提示词结构：复习、整理和自由补充 | 2 小时 |
...
项目：**UX Research Copilot**。本周里程碑：**可版本化的提示词实验记录**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 06 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
