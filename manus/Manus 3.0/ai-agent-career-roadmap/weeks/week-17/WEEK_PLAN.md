# Week 17：测试策略与 Agent Evaluation

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 5：生产化](../../overview/OUTLINE.md)
- 对应书籍章节：[第 44 章](../../book/part-06-production/chapter-44-unit-and-integration-tests.md)、[第 45 章](../../book/part-06-production/chapter-45-agent-evaluation.md)、[第 46 章](../../book/part-06-production/chapter-46-golden-dataset.md)
...
本周处于“生产化”阶段。完成后，你应能说明并实践：单元测试、集成测试、Golden Dataset；同时交付 可重复运行的评测基线。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | 测试策略与 Agent Evaluation：概念与最小示例 | 2–3 小时 |
| Day 2 | 测试策略与 Agent Evaluation：基础编码练习 | 2–3 小时 |
| Day 3 | 测试策略与 Agent Evaluation：功能开发 | 2–3 小时 |
| Day 4 | 测试策略与 Agent Evaluation：工程化改造 | 2–3 小时 |
| Day 5 | 测试策略与 Agent Evaluation：项目开发 | 2–3 小时 |
| Day 6 | 测试策略与 Agent Evaluation：独立挑战与问题修复 | 2 小时 |
| Day 7 | 测试策略与 Agent Evaluation：复习、整理和自由补充 | 2 小时 |
...
项目：**案例分流与合规助手**。本周里程碑：**可重复运行的评测基线**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 18 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
