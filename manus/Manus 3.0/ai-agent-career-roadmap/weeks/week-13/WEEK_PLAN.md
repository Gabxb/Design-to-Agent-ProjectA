# Week 13：Workflow 与 Agent 的边界

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 4：Agent 工作流](../../overview/OUTLINE.md)
- 对应书籍章节：[第 33 章](../../book/part-05-agent-workflows/chapter-33-agent-principles.md)、[第 34 章](../../book/part-05-agent-workflows/chapter-34-agent-or-workflow.md)
...
本周处于“Agent 工作流”阶段。完成后，你应能说明并实践：状态、节点、条件分支；同时交付 可审计的任务分解工作流。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | Workflow 与 Agent 的边界：概念与最小示例 | 2–3 小时 |
| Day 2 | Workflow 与 Agent 的边界：基础编码练习 | 2–3 小时 |
| Day 3 | Workflow 与 Agent 的边界：功能开发 | 2–3 小时 |
| Day 4 | Workflow 与 Agent 的边界：工程化改造 | 2–3 小时 |
| Day 5 | Workflow 与 Agent 的边界：项目开发 | 2–3 小时 |
| Day 6 | Workflow 与 Agent 的边界：独立挑战与问题修复 | 2 小时 |
| Day 7 | Workflow 与 Agent 的边界：复习、整理和自由补充 | 2 小时 |
...
项目：**智能设计评审 Agent**。本周里程碑：**可审计的任务分解工作流**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 14 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
