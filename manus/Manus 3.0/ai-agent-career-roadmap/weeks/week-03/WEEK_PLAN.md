# Week 03：Git、HTTP、JSON 与 FastAPI

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 1：软件工程基础](../../overview/OUTLINE.md)
- 对应书籍章节：[第 9 章](../../book/part-02-software-engineering/chapter-09-git-and-github.md)、[第 10 章](../../book/part-02-software-engineering/chapter-10-http-json-rest.md)、[第 11 章](../../book/part-02-software-engineering/chapter-11-fastapi.md)
...
本周处于“编程与本地开发基础”阶段。完成后，你应能说明并实践：Git 分支、HTTP 状态码、Pydantic；同时交付 带输入验证的 REST API。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | Git 工作流与 HTTP 心智模型 | 2–3 小时 |
| Day 2 | FastAPI 路径、查询与请求体 | 2–3 小时 |
| Day 3 | REST 设计与状态码 | 2–3 小时 |
| Day 4 | 依赖注入与配置 | 2–3 小时 |
| Day 5 | 交互式文档与 API 冒烟测试 | 2–3 小时 |
| Day 6 | 独立挑战：筛选端点 | 2 小时 |
| Day 7 | 复盘：从设计稿到 API 契约 | 2 小时 |
...
项目：**设计需求结构化助手 API**。本周里程碑：**带输入验证的 REST API**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 04 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
