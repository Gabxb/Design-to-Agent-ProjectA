# Week 02：Python 数据建模、异常与测试

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 1：软件工程基础](../../overview/OUTLINE.md)
- 对应书籍章节：[第 7 章](../../book/part-02-software-engineering/chapter-07-types-classes-modules.md)、[第 8 章](../../book/part-02-software-engineering/chapter-08-exceptions-and-logging.md)
...
本周处于“编程与本地开发基础”阶段。完成后，你应能说明并实践：dataclass、异常、pytest；同时交付 含单元测试的数据转换模块。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | 列表、字典与需求字段转换 | 2–3 小时 |
| Day 2 | 类、组合与不可变数据 | 2–3 小时 |
| Day 3 | 异常分类与可测试失败 | 2–3 小时 |
| Day 4 | pytest 参数化与覆盖关键分支 | 2–3 小时 |
| Day 5 | 导出设计需求卡片 | 2–3 小时 |
| Day 6 | 独立挑战：批量导入 | 2 小时 |
| Day 7 | 代码审查与周复盘 | 2 小时 |
...
项目：**设计需求结构化助手 API**。本周里程碑：**含单元测试的数据转换模块**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 03 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
