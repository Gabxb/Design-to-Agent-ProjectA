# Week 19：Docker、CI/CD 与部署

<!-- AUTO_BOOK_NAV_START -->
## 教程书籍导航

- 所属阶段：[阶段 5：生产化](../../overview/OUTLINE.md)
- 对应书籍章节：[第 50 章](../../book/part-06-production/chapter-50-authentication-and-authorization.md)、[第 51 章](../../book/part-06-production/chapter-51-agent-security.md)、[第 52 章](../../book/part-06-production/chapter-52-docker-and-deployment.md)
- 知识地图：[全局学习地图](../../overview/LEARNING_MAP.md) · [24 周路线图](../../overview/ROADMAP_24_WEEKS.md)
- 项目：[案例分流与合规助手](../../projects/project-04-capstone/README.md)
...
本周处于“生产化”阶段。完成后，你应能说明并实践：Docker Compose、健康检查、CI；同时交付 容器化、可部署的 Agent Web 产品。
...
| 日程 | 主题 | 建议投入 |
|---|---|---|
| Day 1 | Docker、CI/CD 与部署：概念与最小示例 | 2–3 小时 |
| Day 2 | Docker、CI/CD 与部署：基础编码练习 | 2–3 小时 |
| Day 3 | Docker、CI/CD 与部署：功能开发 | 2–3 小时 |
| Day 4 | Docker、CI/CD 与部署：工程化改造 | 2–3 小时 |
| Day 5 | Docker、CI/CD 与部署：项目开发 | 2–3 小时 |
| Day 6 | Docker、CI/CD 与部署：独立挑战与问题修复 | 2 小时 |
| Day 7 | Docker、CI/CD 与部署：复习、整理和自由补充 | 2 小时 |
...
项目：**案例分流与合规助手**。本周里程碑：**容器化、可部署的 Agent Web 产品**。将实际实现状态记录到项目 `TASKS.md`。
...
阅读 Week 20 的 `WEEK_PLAN.md`，检查本地运行环境、未完成任务与需准备的非敏感示例数据。
