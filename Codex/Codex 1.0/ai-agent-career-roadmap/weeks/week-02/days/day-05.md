...
CRUD 代表 Create、Read、Update、Delete（创建、读取、更新、删除）。先用内存列表完成路由，重点是资源 ID、状态码和响应结构，不急着接数据库。
...
- **文件路径：** `weeks/week-02/exercises/day-05/`
...
- **创建文件：** 在 `weeks/week-02/exercises/day-05/` 创建 `README.md`、一个 Python 练习文件和必要测试；项目改动放在 `projects/project-01-tool-calling/`。
