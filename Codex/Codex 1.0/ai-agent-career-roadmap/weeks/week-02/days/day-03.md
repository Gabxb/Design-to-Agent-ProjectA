...
REST API 把业务对象映射为资源路径，例如 `/requirements/{id}`。接口契约要说明方法、路径、输入模式、输出模式和错误。先设计契约，再写代码，可以减少前后端和工具调用之间的反复。
...
- **文件路径：** `weeks/week-02/exercises/day-03/`
...
- **创建文件：** 在 `weeks/week-02/exercises/day-03/` 创建 `README.md`、一个 Python 练习文件和必要测试；项目改动放在 `projects/project-01-tool-calling/`。
- **实现内容：** 围绕“JSON”实现一个最小函数、API、检索步骤或工作流节点。
