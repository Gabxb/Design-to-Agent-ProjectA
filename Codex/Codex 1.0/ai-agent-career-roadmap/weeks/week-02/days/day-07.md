...
README 是陌生协作者进入项目的入口。用全新终端按 README 重跑一次，确保命令、路径和端口真实有效。
...
- **文件路径：** `weeks/week-02/exercises/day-07/`
...
- **创建文件：** 在 `weeks/week-02/exercises/day-07/` 创建 `README.md`、一个 Python 练习文件和必要测试；项目改动放在 `projects/project-01-tool-calling/`。
