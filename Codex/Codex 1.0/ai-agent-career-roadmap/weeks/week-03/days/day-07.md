...
从空数据库开始按说明启动 API，创建、查询、更新和删除一条记录。把失败命令和修复步骤写入复盘。
...
- **文件路径：** `weeks/week-03/exercises/day-07/`
...
- **创建文件：** 在 `weeks/week-03/exercises/day-07/` 创建 `README.md`、一个 Python 练习文件和必要测试；项目改动放在 `projects/project-01-tool-calling/`。
