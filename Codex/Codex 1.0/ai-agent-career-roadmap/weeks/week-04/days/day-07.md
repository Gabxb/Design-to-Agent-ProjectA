...
用陌生用户视角完成验收：只看 README 启动服务，运行测试，调用接口，查看日志，再用 5 分钟讲清架构与下一阶段计划。
...
- **文件路径：** `weeks/week-04/exercises/day-07/`
...
- **创建文件：** 在 `weeks/week-04/exercises/day-07/` 创建 `README.md`、一个 Python 练习文件和必要测试；项目改动放在 `projects/project-01-tool-calling/`。
