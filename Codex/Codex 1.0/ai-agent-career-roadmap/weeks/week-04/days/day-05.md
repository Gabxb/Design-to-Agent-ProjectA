...
今天完成从 HTTP 请求到数据库再到响应的完整链路。先跑手动示例，再跑自动测试，最后检查数据库记录。
...
- **文件路径：** `weeks/week-04/exercises/day-05/`
...
- **创建文件：** 在 `weeks/week-04/exercises/day-05/` 创建 `README.md`、一个 Python 练习文件和必要测试；项目改动放在 `projects/project-01-tool-calling/`。
