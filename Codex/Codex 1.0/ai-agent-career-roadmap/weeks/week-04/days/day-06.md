...
独立修复至少一个真实问题，并增加回归测试。优先处理数据校验、重复提交或不存在资源这类业务错误。
...
- **文件路径：** `weeks/week-04/exercises/day-06/`
...
- **创建文件：** 在 `weeks/week-04/exercises/day-06/` 创建 `README.md`、一个 Python 练习文件和必要测试；项目改动放在 `projects/project-01-tool-calling/`。
