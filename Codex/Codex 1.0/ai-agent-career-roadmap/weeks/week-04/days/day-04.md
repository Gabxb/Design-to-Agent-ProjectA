...
结构化日志应包含时间、级别、事件、请求 ID 和关键结果，不应包含密钥。统一异常格式应让调用方知道错误代码、可读信息和是否可重试。
...
- **文件路径：** `weeks/week-04/exercises/day-04/`
...
- **创建文件：** 在 `weeks/week-04/exercises/day-04/` 创建 `README.md`、一个 Python 练习文件和必要测试；项目改动放在 `projects/project-01-tool-calling/`。
- **实现内容：** 围绕“API 测试”实现一个最小函数、API、检索步骤或工作流节点。
