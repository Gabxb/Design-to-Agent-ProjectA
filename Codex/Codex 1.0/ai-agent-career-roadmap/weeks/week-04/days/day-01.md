...
阶段项目先冻结范围。把“什么都能分析”缩小为明确用户、输入、输出和不做事项。每个用户故事都要能映射到接口和验收标准。
...
- **文件路径：** `weeks/week-04/exercises/day-01/`
...
- **创建文件：** 在 `weeks/week-04/exercises/day-01/` 创建 `README.md`、一个 Python 练习文件和必要测试；项目改动放在 `projects/project-01-tool-calling/`。
- **实现内容：** 围绕“配置隔离”实现一个最小函数、API、检索步骤或工作流节点。
