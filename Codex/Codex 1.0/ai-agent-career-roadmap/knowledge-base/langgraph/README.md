...
用状态图组织可分支、循环、暂停和恢复的 Agent 工作流框架。
...
Agent、状态机、Human-in-the-loop

## 12. 官方文档名称或检索关键词

`LangGraph official docs, state graph, checkpointing`
